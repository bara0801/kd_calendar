...
/**
 * Test case for class \KevinDitscheid\KdCalendar\Domain\Model\Time.
 *
 ...
 */
class TimeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \KevinDitscheid\KdCalendar\Domain\Model\Time();
	}
