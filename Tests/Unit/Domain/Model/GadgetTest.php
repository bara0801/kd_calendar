...
/**
 * Test case for class \KevinDitscheid\KdCalendar\Domain\Model\Gadget.
 *
 ...
 */
class GadgetTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \KevinDitscheid\KdCalendar\Domain\Model\Gadget();
	}
	 ...
	 * @test
	 */
	public function getDisplayReturnsInitialValueForInt()
	{	}

	/**
	 * @test
	 */
	public function setDisplayForIntSetsDisplay()
	{	}
	 ...
	 * @test
	 */
	public function getPreferencesReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getPreferences()
		);
	}
	 ...
	 * @test
	 */
	public function setPreferencesForStringSetsPreferences()
	{
		$this->subject->setPreferences('Conceived at T3CON10');
