...
/**
 * Test case for class KevinDitscheid\KdCalendar\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \KevinDitscheid\KdCalendar\Controller\EventController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('KevinDitscheid\\KdCalendar\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
	{
		...
		$eventRepository = $this->getMock('KevinDitscheid\\KdCalendar\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
